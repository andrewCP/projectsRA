...
Los vectores de posición de los cuatro rotores respecto al centro de masa del dron

\begin{equation}
\mathbf{r}_1 =\paragraph{Juan Camilo Blanco}
\section{Matriz de asignacion de actuadores en dron tipo Quad X}
...
Torques producidos por cada rotor
rotor 1
...
\begin{align}
\tau_y &= T_1 + T_2 + T_3 + T_4 \\
       &= L F_{T_1} - L F_{T_2} + L F_{T_3} - L F_{T_4} \\
       &= L\left(F_{T_1} + F_{T_3} - F_{T_2} - F_{T_4}\right) \\
       &= L K_T\left(\Omega_1^2 + \Omega_3^2 - \Omega_2^2 - \Omega_4^2\right)
\end{align}

\begin{align}
\tau_x &= T_2 + T_3 + T_1 + T_4 \\
       &= L\left(F_{T_2} + F_{T_3} - F_{T_1} - F_{T_4}\right) \\
       &= L K_T\left(\Omega_2^2 + \Omega_3^2 - \Omega_1^2 - \Omega_4^2\right)
\end{align}
...
\begin{align}
F_T &= K_T\left(\Omega_1^2 + \Omega_2^2 + \Omega_3^2 + \Omega_4^2\right)
\end{align}
\begin{bmatrix}
\dfrac{L}{\sqrt{2}} \\
\dfrac{L}{\sqrt{2}} \\
